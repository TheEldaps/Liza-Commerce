...
export default function Nav() {
  return (
    <section className="flex justify-between py-[10px] sm:gap-5 w-[90%] sticky top-0 mx-auto mb-[15px] md:mb-[40px] bg-white z-2">
      <div className="flex items-center gap-3">
        <Image src={Logo} width="48" height="48" alt="Platform Logo" />
        <h2 className="text-[1.5rem] font-bold font-[montserrat]">Li-Mart</h2>
      </div>
