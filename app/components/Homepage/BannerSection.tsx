...
export default function BannerSection() {
  return (
    <section className="w-[90%] mx-auto mb-[40px] rounded-3xl bg-[#212844] relative overflow-visible bg-[url('/BannerBg1.png'),url('/BannerBg2.png')] bg-no-repeat bg-[position:bottom_right_50px,top_right_50px] bg-[length:20%,35%]">
