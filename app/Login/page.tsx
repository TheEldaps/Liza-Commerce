          ...
          <div className="w-[50%] max-w-[300px]">
            ...
            <div className="mt-[20px]">
              ...
              <button
                ...
                className="text-right sm:inline-block sm:ml-[10px] block text-[0.8rem] font-[montserrat] text-[white] hover:text-[#e3d2d2cd]"
              >
                Create Account
              </button>
            </div>
        ...
        {form === "forgot password" && (
          <div>
            ...
            <Link
              ...
              className="text-right hover:text-[#e3d2d2cd] cursor-pointer"
            >
              Log in
            </Link>
          </div>
